    ...
    return (
        <div className='w-full'>
            <div className="flex items-center gap-5">
                ...
                <div className="text-stone-500 text-[21.73px] font-bold ">Registration Configuration</div>
            </div>
            <div className="mt-10 lg:pl-16 w-full">
                <div className="flex items-center gap-3">
                    <Dot className={"w-2 h-2 bg-black"} />
                    <h4 className='text-xs font-semibold'>
                        Configure the new registration to send to parents so they can do it online
                    </h4>
                </div>
