  ...
  return (
    ...
    >
      ...
      >
        {type !== "image" ? (
          <div
            className={`min-w-24 max-w-[300px] messageCard flex items-center justify-center py-3 ${
              isLast && position === "left"
          ...
          >
            <p
              className={`${
                position === "left" ? "text-gray-800" : "text-[#187A82]"
              } text-xs font-normal`}
            >
              {text}
            </p>
        ...
        {isLast && (
          <div className="text-[#187A82] text-xs font-normal mt-2 px-4 flex items-center">
            {moment(date).fromNow()}
            {position === "right" && (
              <>
                {message?.seen && (
                  <span className="text-[14px] ml-1 text-green-600">Seen</span>
                )}
              </>
            )}
          </div>
