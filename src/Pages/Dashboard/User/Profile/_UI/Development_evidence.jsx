...
const Development_evidence = () => {
    ...
    return (
        <LocalizationProvider dateAdapter={AdapterDayjs}>
            <div className='w-full px-8 py-[55px] rounded-xl poppins bg-[#F1F6FA63]'>
                ...
                <div className="border-2 p-5 bg-white mt-10 rounded-xl">
                    <h2 className="text-center mt-3 text-neutral-400 text-lg font-bold ">Development Stage</h2>
                    <div className="min-h-[450px] w-full  mt-10">
                ...
                <h1 className="text-gray-600 text-2xl mt-10 font-bold ">
                    Development List
                </h1>
...
const THead = ({ title }) => {
    return <div className='text-xs flex justify-center items-center'>
        {title}
    </div>
}
...
const TBody = ({ title, number, row, last }) => {
    ...
    return <div className={`text-xs flex justify-start p-3 items-start h-[90.82px] border-l border-b border-blue-gray-50 ${row === 1 && "border-t"} ${last && "border-r"}`}>
        {
            number === 0 ?
                <div className="text-zinc-800 text-[10.31px] font-semibold  tracking-tight">4-5 Months</div>
                : ""
        }
    </div>
}
...
const ListCard = ({ title, desc }) => {
    return <Card className='shadow-none border border-[#C2E5FF] h-[85px] justify-center px-10'>
        <div className="flex items-center justify-between">
            <h1 className=" text-black text-base font-medium ">Headline Topic Goes Here</h1>
            <div className="flex gap-4">
                <button className="w-[50px] h-[50px] bg-[#FF36361C]
                flex justify-center items-center text-[#FF3636] rounded-full
                ">
                    <FontAwesomeIcon icon={faTrashCan} />
                </button>
                <button className="w-[50px] h-[50px] bg-[#FFBB3B33]
